...
export default function LatestaArticles() {
  return (
    <>
            ...
            >
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-white mb-5 group-hover:text-orange-500 transition-colors duration-300 line-clamp-2 leading-tight">
