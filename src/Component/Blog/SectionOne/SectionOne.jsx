  ...
  return (
    <>
      <section className="relative min-h-[60vh] pt-[50px] flex items-center overflow-hidden bg-[#0a0a0a]">
        ...
        {/* Blobs */}
        <div className="absolute top-16 left-6 w-72 h-72 bg-orange-500/10 rounded-full blur-3xl" />
        ...
        <div className=" z-20 max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          >
            ...
            <i class="fa-regular fa-file-lines text-[14px] text-orange-500 "></i>
               مدونتنا 
          </span>
        ...
        <div
          class="absolute inset-0 bg-[linear-gradient(rgba(38,38,38,0.5)_1px,transparent_1px),linear-gradient(90deg,rgba(38,38,38,0.5)_1px,transparent_1px)]
         bg-[size:60px_60px]"
        ></div>
      </section>
    </>
